...
TableCliente.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableCliente.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);

//
TableProveedor.getColumnModel().getColumn(0).setMaxWidth(0);
TableProveedor.getColumnModel().getColumn(0).setMinWidth(0);
TableProveedor.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableProveedor.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);

//
TableProducto.getColumnModel().getColumn(0).setMaxWidth(0);
TableProducto.getColumnModel().getColumn(0).setMinWidth(0);
TableProducto.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableProducto.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);

//

TableVenta.getColumnModel().getColumn(0).setMaxWidth(0);
TableVenta.getColumnModel().getColumn(0).setMinWidth(0);
TableVenta.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableVenta.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);
//
TableVentas.getColumnModel().getColumn(0).setMaxWidth(0);
TableVentas.getColumnModel().getColumn(0).setMinWidth(0);
TableVentas.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableVentas.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);

TableUsuarios.getColumnModel().getColumn(0).setMaxWidth(0);
TableUsuarios.getColumnModel().getColumn(0).setMinWidth(0);
TableUsuarios.getTableHeader().getColumnModel().getColumn(0).setMaxWidth(0);
TableUsuarios.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0); 
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(185, 166, 224));

        btnNuevaVenta.setBackground(new java.awt.Color(235, 240, 242));
        ...
        btnClientes.setBackground(new java.awt.Color(235, 240, 242));
        ...
        btnProveedor.setBackground(new java.awt.Color(235, 240, 242));
        ...
        btnProductos.setBackground(new java.awt.Color(235, 240, 242));
        ...
        btnVentas.setBackground(new java.awt.Color(235, 240, 242));
        ...
        btnUsuarios.setBackground(new java.awt.Color(235, 240, 242));
        ...
        jPanel47.setBackground(new java.awt.Color(139, 223, 226));
        ...
        getContentPane().add(jPanel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 870, 120));
        ...
        jPanel2.add(btnGenerarVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, 80, 30));

        jLabel10.setText("Total a Pagar:");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 380, -1, 20));
        ...
        jPanel19.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel20.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel21.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel22.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel23.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel24.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel25.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, -1, -1));
        ...
        jPanel9.add(txtIdCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 30, -1));

        btnGuardarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/agregarP.png"))); // NOI18N
        ...
        jPanel9.add(btnGuardarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 60, 35));

        btnEditarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/editarP.png"))); // NOI18N
        ...
        jPanel9.add(btnEditarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 70, 35));
        ...
        jPanel9.add(btnEliminarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, 70, 35));
        ...
        jPanel9.add(btnNuevoCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 70, 35));

        jPanel26.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel27.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel28.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel29.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel46.setBackground(new java.awt.Color(66, 55, 106));
        ...
        btnguardarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/agregarP.png"))); // NOI18N
        ...
        btnEditarProveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/editarP.png"))); // NOI18N
        ...
        jPanel34.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel35.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel36.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel37.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel38.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel11.add(btnGuardarpro, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 40, 35));
        ...
        jPanel11.add(btnEditarpro, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 50, 35));
        ...
        jPanel11.add(btnEliminarPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 330, 50, 35));
        ...
        jPanel11.add(btnNuevoPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 330, 60, 35));

        jPanel30.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel31.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel32.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel33.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel39.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jLabel34.setForeground(new java.awt.Color(66, 55, 106));
        ...
        jLabel35.setForeground(new java.awt.Color(66, 55, 106));
        ...
        btnIniciar.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jLabel36.setForeground(new java.awt.Color(66, 55, 106));
        ...
        jLabel37.setForeground(new java.awt.Color(66, 55, 106));
        ...
        jPanel15.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel16.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel17.setBackground(new java.awt.Color(66, 55, 106));
        ...
        jPanel18.setBackground(new java.awt.Color(66, 55, 106));
    ...
    private void btnClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClientesActionPerformed
        int Seleccionada = TableVenta.getModel().getRowCount();

        if(Seleccionada!=0||txtCodigoVenta.getText().length()!=0){
             System.out.println("Es igual a 1");
        int input = JOptionPane.showConfirmDialog(null, 
        "Tienes una venta pendiente, ¿Deseas cancelarla?", "Cancelar venta",JOptionPane.YES_NO_OPTION);      
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        if (txtNombre.getText().equals("") || txtCorreo.getText().equals("") || txtPass.getPassword().equals("")||!txtCorreo.getText().contains("@gmail.com")) {
            JOptionPane.showMessageDialog(null, "Todo los campos son requeridos y un correo valido");
        } else {
    ...
    private void txtPrecioProKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPrecioProKeyTyped
        // TODO add your handling code here:
          if(txtPrecioPro.getText().length()>=6){
            evt.consume();
        }
...
if(txtNombreCliente.getText().length() >= 5)
    {
        evt.consume();
    ...
    private void txtCantidadVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCantidadVentaKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER&&!txtCodigoVenta.equals("")) {
                  ...
                  //  System.out.println(stock);
                   // stocki=stocki-cant;
                    ...
                    for (int i = 0; i < TableVenta.getRowCount(); i++) {
                       if (TableVenta.getValueAt(i, 1).equals(txtDescripcionVenta.getText())&&Integer.parseInt(txtCantidadVenta.getText())<=stock) {
                            int tem = Integer.parseInt(txtCantidadVenta.getText());

                            DefaultTableModel tm = (DefaultTableModel) TableVenta.getModel();
                           String dato=String.valueOf(tm.getValueAt(i,2));
                              //dato que esta en el valueof
                           int dat =Integer.parseInt(dato);
                           dat+=tem;
                           
                           TableVenta.setValueAt(dat, i, 2);
                            
                           
                           //pruebas
                           String datito=String.valueOf(cant);
                           int datitoInt = Integer.valueOf(datito);
                           stock=stock-datitoInt;
                           System.out.println("Datitoint:" +datitoInt);
                           System.out.println("cant " + stock);
                                   
                           //costo unitario
                          double cal = Double.parseDouble(String.valueOf(TableVenta.getModel().getValueAt(i, 4)));
                          cal = dat *precio;
                            TableVenta.setValueAt(cal, i, 4);
 ...
 return -1;
    ...
    private void txtCodigoVentaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoVentaKeyTyped
        // TODO add your handling code here:
        event.numberKeyPress(evt);
        if(txtNombreCliente.getText().length() >= 10)
    {
        evt.consume();
    }
...
event.textKeyPress(evt);    }//GEN-LAST:event_txtNombreClienteKeyTyped
...
if(txtDirecionCliente.getText().length() >= 30)
    {
        evt.consume();
...
if(txtRucProveedor.getText().length() >= 10)
    {
        evt.consume();
    }
        event.numberKeyPress(evt);    }//GEN-LAST:event_txtRucProveedorKeyTyped

    private void txtNombreproveedorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreproveedorKeyTyped
 event.textKeyPress(evt);

        
        if(txtNombreproveedor.getText().length() >= 30)
    {
        evt.consume();
...
event.numberKeyPress(evt);
        if(txtTelefonoProveedor.getText().length() >=11)
    {
        evt.consume();
    }    }//GEN-LAST:event_txtTelefonoProveedorKeyTyped

    private void txtDireccionProveedorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDireccionProveedorKeyTyped
if(txtDesPro.getText().length() >= 30)
    {
        evt.consume();
...
event.numberKeyPress(evt);
                if(txtCantPro.getText().length()>3){
                    evt.consume();
